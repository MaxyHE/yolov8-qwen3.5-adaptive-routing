"""
YOLO + Qwen3.5 全量VLM评估（所有框都送VLM）
用法：
python eval_qwen_full.py \
...
from eval_utils import (get_img_ids, load_voc_annotations, measure_vram,
                        ...
                        update_confusion, print_confusion_summary)
...
def main(args):
    ...
    with open("results_qwen_full.json", "w") as f:
        json.dump(result, f, indent=2)
    print("\n结果已保存到 results_qwen_full.json")
